...
<div class="page">
    <div class="topbar">
        ...
        <div class="actions">
            <a class="btn btn-primary" href="<?php echo e(url('/admin/funnels')); ?>">Admin Dashboard</a>
            <a class="btn" href="<?php echo e(url('/admin/submissions')); ?>">View Submissions</a>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="content">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($funnels->isEmpty()): ?>
                <div class="empty">
            ...
            <?php else: ?>
                <div class="grid">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $funnels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="funnel" href="<?php echo e(route('funnels.landing', $f->slug)); ?>">
                            <p class="name"><?php echo e($f->title); ?></p>
                            <div class="meta">
                                <span class="pill">Public URL</span>
                                <span>/f/<?php echo e($f->slug); ?></span>
                            </div>
                        </a>
...
<?php echo $__env->make('layouts.funnel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\xampp\sale-funnal\resources\views/home.blade.php ENDPATH**/ ?>