...
<?php $__env->startSection('title', 'Edit Routing Rule'); ?>
...
<div class="page">
  ...
  <div class="topbar">
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap;">
          <a class="btn" href="<?php echo e(route('admin.funnels.rules.index', $funnel)); ?>">Back</a>
          <a class="btn" href="<?php echo e(route('admin.funnels.questions.index', $funnel)); ?>">Questions</a>
      </div>
  </div>

  <div class="card">
      <form method="POST" action="<?php echo e(route('admin.funnels.rules.update', [$funnel, $rule])); ?>">
          <?php echo csrf_field(); ?>
          ...
          <div class="grid">
              <div>
                  ...
                  <input class="input" name="tag"
                         value="<?php echo e(old('tag', $rule->tag)); ?>"
                         placeholder="IUL_Prospect">
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['tag'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              ...
              <div>
                  ...
                  <input class="input" type="number" min="1" max="9999" name="priority"
                         value="<?php echo e(old('priority', $rule->priority)); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              ...
              <div style="grid-column: span 2;">
                  ...
                  <textarea class="textarea" name="conditions_json"
                            placeholder='[{"question_key":"age_range","op":"in","value":["25–35"]}]'><?php echo e(old('conditions_json', $json)); ?></textarea>

                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['conditions_json'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="err"><?php echo e($message); ?></div> <?php unset($message);
  ...
  {"question_key":"goal","op":"in","value":["Grow tax-free","Leave a legacy"]}
              ...
              <div style="grid-column: span 2;">
                  ...
                  <input class="input" name="thankyou_title"
                         value="<?php echo e(old('thankyou_title', $rule->thankyou_title)); ?>"
                         placeholder="You may qualify for a tax-advantaged strategy...">
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['thankyou_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="err"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              ...
              <div style="grid-column: span 2;">
                  ...
                  <textarea class="input" style="min-height:120px;" name="thankyou_body"
                            placeholder="Write a short thank you message shown to the user..."><?php echo e(old('thankyou_body', $rule->thankyou_body)); ?></textarea>
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['thankyou_body'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="err"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:flex-end;margin-top:14px;">
              <a class="btn" href="<?php echo e(route('admin.funnels.rules.index', $funnel)); ?>">Cancel</a>
...
<?php echo $__env->make('layouts.funnel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\xampp\sale-funnal\resources\views/admin/rules/edit.blade.php ENDPATH**/ ?>