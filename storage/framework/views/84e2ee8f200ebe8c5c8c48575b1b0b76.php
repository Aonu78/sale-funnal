...
<?php $__env->startSection('title', 'Create Templates'); ?>
...
<div class="wrap">
    <div class="header">
        <div>
            ...
            <p>Build reusable templates with variables so you can send consistent, branded emails faster.</p>
        </div>
    ...
    <form method="POST" action="<?php echo e(route('admin.email-templates.store')); ?>" class="card">
        <?php echo csrf_field(); ?>

        <div class="card-head">
            <span class="kicker"><span class="dot"></span> Template Details</span>
        </div>
        ...
        <div class="card-body">
            <div class="grid">
                <div class="field">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" class="control" placeholder="e.g., Welcome Email" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="field">
                    ...
                    <input type="text" name="category" id="category" value="<?php echo e(old('category')); ?>" class="control" placeholder="e.g., Onboarding / Billing / Support">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="field" style="margin-top:14px;">
                ...
                <input type="text" name="subject" id="subject" value="<?php echo e(old('subject')); ?>" class="control" placeholder="e.g., Welcome, !" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="field" style="margin-top:14px;">
                ...
                <textarea name="body" id="body" rows="10" class="control" placeholder="Write the email body here..." required><?php echo e(old('body')); ?></textarea>
                <div class="hint">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="grid" style="margin-top:14px;">
                <div class="field">
                    ...
                    <textarea name="description" id="description" rows="3" class="control" placeholder="Internal notes (optional)"><?php echo e(old('description')); ?></textarea>
                    <div class="hint">Shown to admins only. Helps your team understand when to use this template.</div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="field">
                    ...
                    <textarea name="variables" id="variables" rows="3" class="control" placeholder='["name","email"]'><?php echo e(old('variables')); ?></textarea>
                    <div class="hint">
                        Enter a JSON array of variable keys you intend to support (optional). Example: <code>["name","email"]</code>
                    </div>
...
<?php echo $__env->make('layouts.funnel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\xampp\sale-funnal\resources\views/admin/email-templates/create.blade.php ENDPATH**/ ?>