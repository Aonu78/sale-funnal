...
<div class="page">
    <div class="topbar">
        ...
        <div class="actions">
            ...
            <a class="btn btn-dark" href="{{ url('/admin/funnels') }}">Funnels</a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="filters">
            <form method="GET">
                ...
                <div class="filters-actions">
                    <div class="muted">
                        Showing <strong>{{ $submissions->count() }}</strong> on this page
                        (page {{ $submissions->currentPage() }} of {{ $submissions->lastPage() }})
                    </div>

                    <div style="display:flex;gap:10px;flex-wrap:wrap;">
                        <button class="btn-apply" type="submit">Apply Filters</button>
                        <a class="btn" href="{{ route('admin.submissions.export', request()->query()) }}">
                            Export CSV
                        </a>
                        <a class="btn" href="{{ route('admin.submissions.index') }}">Reset</a>
                    </div>
        ...
        <div class="table-wrap">
            <div class="table-head">
                <span class="count-pill">Total results: {{ $submissions->total() }}</span>
