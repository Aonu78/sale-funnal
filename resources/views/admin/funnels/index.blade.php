...
<div class="page">
    <div class="topbar">
        ...
        <div class="actions">
            <a class="btn" href="{{ url('/admin') }}">Home</a>
            <a class="btn btn-dark" href="{{ route('admin.submissions.index') }}">Submissions</a>
            <a class="btn btn-primary" href="{{ route('admin.funnels.create') }}">+ Create Funnel</a>
        </div>
    </div>
        ...
        <div class="table-wrap">
            <table>
                ...
                @forelse($funnels as $funnel)
                    <tr>
                        <td><strong>{{ $funnel->title }}</strong></td>
                        <td class="mono">{{ $funnel->slug }}</td>
                        <td>
                            @if($funnel->is_active)
                        ...
                        <td>
                            <a class="link" target="_blank" href="{{ route('funnels.landing', $funnel->slug) }}">Open</a>
                        </td>
                        <td>
                            <div class="actions-cell">
                                <a class="btn" href="{{ route('admin.funnels.edit', $funnel) }}">Edit</a>
                                <a class="btn" href="{{ route('admin.submissions.export', ['funnel_id' => $funnel->id]) }}">Export CSV</a>
                                <a class="btn" href="{{ route('admin.funnels.questions.index', $funnel) }}">Builder</a>
                                <a class="btn" href="{{ route('admin.funnels.rules.index', $funnel) }}">Rules</a>
