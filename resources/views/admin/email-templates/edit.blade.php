...
<div class="wrap">
    ...
    <form method="POST" action="{{ route('admin.email-templates.update', $emailTemplate) }}" class="card">
        @csrf
        @method('PUT')
        ...
        <div class="card-body">
            ...
            <div class="field" style="margin-top:14px;">
                ...
                <input type="text" name="subject" id="subject"
                       ...
                       class="control"
                       placeholder="e.g., Welcome, {{ $emailTemplate->name }} !"
                       required>
                @error('subject')
                    <div class="error">{{ $message }}</div>
                @enderror
            ...
            <div class="grid" style="margin-top:14px;">
                <div class="field">
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="control"
                              placeholder="Internal notes (optional)">{{ old('description', $emailTemplate->description) }}</textarea>
                ...
                <div class="field">
                    ...
                    <textarea name="variables" id="variables" rows="3"
                              class="control"
                              placeholder='["name","email"]'>{{ old('variables', is_string($emailTemplate->variables) ? $emailTemplate->variables : json_encode($emailTemplate->variables)) }}</textarea>
                    <div class="hint">
